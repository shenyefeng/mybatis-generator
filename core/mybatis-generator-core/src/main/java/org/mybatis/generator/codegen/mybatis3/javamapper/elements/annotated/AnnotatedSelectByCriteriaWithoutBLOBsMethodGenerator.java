 ...
 * @author Jeff Butler
 */
public class AnnotatedSelectByCriteriaWithoutBLOBsMethodGenerator extends
    SelectByCriteriaWithoutBLOBsMethodGenerator {

    public AnnotatedSelectByCriteriaWithoutBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getSelectByCriteriaStatementId());
        sb.append("\")"); //$NON-NLS-1$
