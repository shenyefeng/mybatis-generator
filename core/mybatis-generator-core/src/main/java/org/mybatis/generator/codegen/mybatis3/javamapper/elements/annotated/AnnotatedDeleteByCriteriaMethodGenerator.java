 ...
 * @author Jeff Butler
 */
public class AnnotatedDeleteByCriteriaMethodGenerator extends
        DeleteByCriteriaMethodGenerator {

    public AnnotatedDeleteByCriteriaMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getDeleteByCriteriaStatementId());
        sb.append("\")"); //$NON-NLS-1$
