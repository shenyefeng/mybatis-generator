 ...
 * @author Jeff Butler
 */
public class AnnotatedUpdateByCriteriaSelectiveMethodGenerator extends
    UpdateByCriteriaSelectiveMethodGenerator {

    public AnnotatedUpdateByCriteriaSelectiveMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getUpdateByCriteriaSelectiveStatementId());
        sb.append("\")"); //$NON-NLS-1$
