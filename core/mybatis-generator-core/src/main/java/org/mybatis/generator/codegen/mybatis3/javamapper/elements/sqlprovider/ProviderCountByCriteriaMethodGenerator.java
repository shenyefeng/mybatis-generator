 ...
 * 
 */
public class ProviderCountByCriteriaMethodGenerator extends
        AbstractJavaProviderMethodGenerator {

    public ProviderCountByCriteriaMethodGenerator(boolean useLegacyBuilder) {
    ...
    public void addClassElements(TopLevelClass topLevelClass) {
        ...
        Method method = new Method(
                introspectedTable.getCountByCriteriaStatementId());
        ...
        if (context.getPlugins().providerCountByCriteriaMethodGenerated(method, topLevelClass,
                introspectedTable)) {
