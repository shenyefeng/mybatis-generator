 ...
 * @author Jeff Butler
 */
public class AnnotatedUpdateByCriteriaWithoutBLOBsMethodGenerator extends
    UpdateByCriteriaWithoutBLOBsMethodGenerator {

    public AnnotatedUpdateByCriteriaWithoutBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getUpdateByCriteriaStatementId());
        sb.append("\")"); //$NON-NLS-1$
