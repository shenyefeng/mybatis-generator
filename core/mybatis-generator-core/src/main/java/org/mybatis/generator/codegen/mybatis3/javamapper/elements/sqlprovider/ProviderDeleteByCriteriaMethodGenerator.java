 ...
 * 
 */
public class ProviderDeleteByCriteriaMethodGenerator extends
        AbstractJavaProviderMethodGenerator {

    public ProviderDeleteByCriteriaMethodGenerator(boolean useLegacyBuilder) {
    ...
    public void addClassElements(TopLevelClass topLevelClass) {
        ...
        Method method = new Method(
                introspectedTable.getDeleteByCriteriaStatementId());
        ...
        if (context.getPlugins().providerDeleteByCriteriaMethodGenerated(method, topLevelClass,
                introspectedTable)) {
