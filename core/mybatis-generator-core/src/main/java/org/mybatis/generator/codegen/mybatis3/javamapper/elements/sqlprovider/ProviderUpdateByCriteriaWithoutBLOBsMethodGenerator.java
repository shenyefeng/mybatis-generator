 ...
 * 
 */
public class ProviderUpdateByCriteriaWithoutBLOBsMethodGenerator extends
        AbstractJavaProviderMethodGenerator {

	public ProviderUpdateByCriteriaWithoutBLOBsMethodGenerator(boolean useLegacyBuilder) {
    ...
    public String getMethodName() {
        return introspectedTable.getUpdateByCriteriaStatementId();        
    }
    ...
    public boolean callPlugins(Method method, TopLevelClass topLevelClass) {
        return context.getPlugins().providerUpdateByCriteriaWithoutBLOBsMethodGenerated(method, topLevelClass,
                introspectedTable);
    }
}
