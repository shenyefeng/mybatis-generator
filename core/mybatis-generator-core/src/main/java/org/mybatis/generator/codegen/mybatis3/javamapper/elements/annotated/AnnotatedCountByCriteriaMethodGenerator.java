 ...
 * @author Jeff Butler
 */
public class AnnotatedCountByCriteriaMethodGenerator extends
    CountByCriteriaMethodGenerator {

    public AnnotatedCountByCriteriaMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getCountByCriteriaStatementId());
        sb.append("\")"); //$NON-NLS-1$
