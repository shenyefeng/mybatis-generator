 ...
 * 
 */
public class ProviderSelectByCriteriaWithoutBLOBsMethodGenerator extends
        AbstractJavaProviderMethodGenerator {

    public ProviderSelectByCriteriaWithoutBLOBsMethodGenerator(boolean useLegacyBuilder) {
    ...
    public String getMethodName() {
        return introspectedTable.getSelectByCriteriaStatementId();        
    }
    
    public boolean callPlugins(Method method, TopLevelClass topLevelClass) {
        return context.getPlugins().providerSelectByCriteriaWithoutBLOBsMethodGenerated(method, topLevelClass,
                introspectedTable);
    }
}
