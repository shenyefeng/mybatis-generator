 ...
 * @author Jeff Butler
 */
public class AnnotatedSelectByCriteriaWithBLOBsMethodGenerator extends
    SelectByCriteriaWithBLOBsMethodGenerator {

    public AnnotatedSelectByCriteriaWithBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getSelectByCriteriaWithBLOBsStatementId());
        sb.append("\")"); //$NON-NLS-1$
