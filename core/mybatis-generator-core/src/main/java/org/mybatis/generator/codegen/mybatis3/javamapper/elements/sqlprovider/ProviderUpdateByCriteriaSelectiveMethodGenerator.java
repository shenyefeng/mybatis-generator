 ...
 * 
 */
public class ProviderUpdateByCriteriaSelectiveMethodGenerator extends
        AbstractJavaProviderMethodGenerator {

	public ProviderUpdateByCriteriaSelectiveMethodGenerator(boolean useLegacyBuilder) {
    ...
    public void addClassElements(TopLevelClass topLevelClass) {
        ...
        Method method = new Method(introspectedTable.getUpdateByCriteriaSelectiveStatementId());
        ...
        if (context.getPlugins().providerUpdateByCriteriaSelectiveMethodGenerated(method, topLevelClass,
                introspectedTable)) {
