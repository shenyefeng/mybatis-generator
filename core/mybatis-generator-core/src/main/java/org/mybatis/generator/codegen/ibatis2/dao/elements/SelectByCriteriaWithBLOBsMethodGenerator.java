 ...
 * 
 */
public class SelectByCriteriaWithBLOBsMethodGenerator extends
        AbstractDAOElementGenerator {

    private boolean generateForJava5;

    public SelectByCriteriaWithBLOBsMethodGenerator(boolean generateForJava5) {
        super();
    ...
    public void addImplementationElements(TopLevelClass topLevelClass) {
        ...
        sb.append(daoTemplate.getQueryForListMethod(introspectedTable
                ...
                .getSelectByCriteriaWithBLOBsStatementId(), "criteria")); //$NON-NLS-1$
        method.addBodyLine(sb.toString());
        method.addBodyLine("return list;"); //$NON-NLS-1$

        if (context.getPlugins()
                .clientSelectByCriteriaWithBLOBsMethodGenerated(method,
    ...
    private Method getMethodShell(Set<FullyQualifiedJavaType> importedTypes) {
        ...
        method.setName(getDAOMethodNameCalculator()
                .getSelectByCriteriaWithBLOBsMethodName(introspectedTable));
