 ...
 * @author Jeff Butler
 */
public class AnnotatedUpdateByCriteriaWithBLOBsMethodGenerator extends
    UpdateByCriteriaWithBLOBsMethodGenerator {

    public AnnotatedUpdateByCriteriaWithBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getUpdateByCriteriaWithBLOBsStatementId());
        sb.append("\")"); //$NON-NLS-1$
