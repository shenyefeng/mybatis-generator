 ...
 * 
 */
public class CriteriaWhereClauseElementGenerator extends
        AbstractXmlElementGenerator {

    private boolean isForUpdateByCriteria;

    public CriteriaWhereClauseElementGenerator(boolean isForUpdateByCriteria) {
        super();
        this.isForUpdateByCriteria = isForUpdateByCriteria;
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        if (isForUpdateByCriteria) {
            answer
                    .addAttribute(new Attribute(
                            "id", introspectedTable.getMyBatis3UpdateByCriteriaWhereClauseId())); //$NON-NLS-1$
        } else {
